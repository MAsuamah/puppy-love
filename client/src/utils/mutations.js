...
export const DELETE_USER = gql`
  mutation deleteUser($id: ID, $username: String!, $email: String!, $password: String!) {
    deleteUser(_id: $id, username: $username, email: $email, password: $password) {
      token
      user {
        _id
        username
...
export const ADD_DOG = gql`
  mutation addDog($username: String!, $name: String!, $gender: String, $breed: String, $age: Int) {
    addDog(username: username, name: $name, gender: $gender, breed: $breed, age: $age) {
      dog {
        _id
        name
        owner
